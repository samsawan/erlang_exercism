...
right_test() ->
  ...
  ?assertEqual(robot_simulator:direction(Robot), east ),
  ?assertEqual(robot_simulator:position(Robot), Position ),
  robot_simulator:right( Robot ),
  ?assertEqual(robot_simulator:direction(Robot), south ),
  ?assertEqual(robot_simulator:position(Robot), Position ),
  robot_simulator:right( Robot ),
  ?assertEqual(robot_simulator:direction(Robot), west ),
  ?assert( robot_simulator:position(Robot) =:= Position ),
  robot_simulator:right( Robot ),
  ?assertEqual(robot_simulator:direction(Robot), north ),
  ?assertEqual(robot_simulator:position(Robot), Position ).
